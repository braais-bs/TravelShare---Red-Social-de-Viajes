...
try {
    ...
    if ($id_cronica <= 0) die("Crónica no especificada.");
    ...
    if (!$cronica) die("Crónica no encontrada.");
        ...
        <div class="estructura">
            ...
            <main>
                <header class="caja-encabezado-principal">
                    ...
                    <p class="subtitulo-principal">Lee la experiencia de viaje de otro usuario</p>
                </header>
                ...
                <div class="caja-principal comentarios" id="comentarios-seccion">
