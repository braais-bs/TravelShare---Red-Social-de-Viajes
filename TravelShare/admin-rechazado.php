...
try {
    ...
    ");
    $cronicas_rechazadas = $stmt_cronicas->fetchAll(PDO::FETCH_ASSOC);
...
<html lang="es">
    <head>
        ...
        <title>Administrador Rechazados</title>
        ...
        <div class="estructura">
            ...
            <main>
                ...
                <div class="panel-resumen">
                    ...
                    <a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="resumen-caja rechazada">
                        <div class="resumen-titulo">
                ...
                <div class="texto-admin-cronicas">
                    <h2>Crónicas Rechazadas</h2>
                </div>

                <div class="caja-principal">
                    <div class="cronicas-alargadas">
                        <?php if (!empty($cronicas_rechazadas)): ?>
                            <?php foreach ($cronicas_rechazadas as $cronica): ?>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p class="sin-experiencias">No hay crónicas rechazadas en los últimos 30 días</p>
                        <?php endif; ?>
                    </div>
                </div>
            </main>
