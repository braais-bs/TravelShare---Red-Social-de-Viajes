...
try {
    ...
    ");
    $cronicas_pendientes = $stmt_cronicas->fetchAll(PDO::FETCH_ASSOC);
...
<html lang="es">
    <head>
        ...
        <title>Administrador Pendientes</title>
        ...
        <div class="estructura">
            ...
            <main>
                ...
                <div class="panel-resumen">
                    <a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="resumen-caja pendiente">
                    ...
                    <a href="admin-aprobado.php" class="resumen-caja aprobada">
                        <div class="resumen-titulo">
                            <span>Aprobadas</span>
                            <span class="resumen-icono"></span>
                        </div>
                ...
                <div class="texto-admin-cronicas">
                    <h2>Crónicas Pendientes</h2>
                </div>

                <div class="caja-principal">
                    <div class="cronicas-alargadas">
                        <?php if (!empty($cronicas_pendientes)): ?>
                            <?php foreach ($cronicas_pendientes as $cronica): ?>
                                <a href="admin-cronica-decision.php?id=<?php echo $cronica['id_cronica']; ?>" class="enlace-leer-cronica">
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p class="sin-experiencias">No hay crónicas pendientes de revisión</p>
                        <?php endif; ?>
                    </div>                  
                </div>
            </main>
            ...
            <aside>
                ...
                <nav class="menu-principal">
                    <div class="grupo-menu">
                        ...
                        <a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="enlace-menu activo administrador">Administrador</a>
                    </div>
                </nav>
            </aside>
        </div>
