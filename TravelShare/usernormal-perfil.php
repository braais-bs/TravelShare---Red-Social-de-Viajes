        ...
        <div class="estructura">
                ...
                <div class="caja-principal">
                    ...
                    <div class="info-usuario">
                        ...
                        <div class="foto-usuario">
                            <img src="<?= htmlspecialchars(!empty($usuario['foto_perfil']) ? $usuario['foto_perfil'] : 'imagenes/NoUser.png') ?>" 
                                 onerror="this.onerror=null; this.src='imagenes/NoUser.png';"
                                 alt="Foto de perfil">
                        </div>
                        <div class="datos-usuario">
                            ...
                            <div class="datos-adicionales">
                                <span class="ubicacion-usuario"><?= htmlspecialchars($usuario['ubicacion'] ?: 'No especificada') ?></span>
                                <span class="etiqueta-rol"><?= ucfirst($usuario['rol']) ?></span>
                                <?php if ($usuario['rol'] == 'normal'): ?>
                                    <a href="usernormal-cambiorol.php" class="cambiar-rol">¡Únete a nosotros!</a>
                                <?php endif; ?>
                            </div>
            ...
            <aside>
                <img class="foto-perfil"
                     src="<?php echo htmlspecialchars(!empty($usuario['foto_perfil']) ? $usuario['foto_perfil'] : 'imagenes/NoUser.png'); ?>"
                     onerror="this.onerror=null; this.src='imagenes/NoUser.png';"
